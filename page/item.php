		...
		<div class="row" >
			<div class="col-12 px-1" >
				...
				<div style="font-size:90%;">
					Merk: <a href="<?php echo $path_exp["1"]."/b/".\P\Brands\brandID_to_Name($row["[sh_brand_names]Id"])."/".$row["[sh_brand_names]Id"]; ?>"><?php echo \P\Brand\brandID_to_Name($row["[sh_brand_names]Id"]); ?></a>
					|
